...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        //let bgcolor = UIColor(red: 143/255.0, green: 255/255.0, blue: 180/255.0, alpha: 1.0)
        //view.backgroundColor = bgcolor
        UIGraphicsBeginImageContext(self.view.frame.size)
        UIImage(named: "landingImage")?.draw(in: self.view.bounds)
